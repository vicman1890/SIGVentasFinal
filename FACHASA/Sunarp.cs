    ...
    public class Sunarp
    {
        ...
        private Image ReadCapcha()
        {
            try
            {
                ...
                HttpWebRequest myWebRequest = (HttpWebRequest)WebRequest.Create("https://www.sunarp.gob.pe/ConsultaVehicular/verificaPlaca.aspx?oboutcaptchaguid=5211491&width=240&height=40");
